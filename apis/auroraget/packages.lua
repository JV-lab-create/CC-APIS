...
local link = {
    ["store"] = {
        ...
        ["DiscordHook"] = { type = "file", fileURL = "https://raw.githubusercontent.com/Wendelstein7/DiscordHook-CC/master/DiscordHook.lua", filePath = "/apis/skynet.lua", name = "Discord Hook"} 
        ["skynet"] = { type = "file", fileURL = "https://raw.githubusercontent.com/osmarks/skynet/master/client.lua", filePath = "/apis/skynet.lua", name = "Lua IDE"}
